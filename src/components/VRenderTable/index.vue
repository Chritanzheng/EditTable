      ...
      <thead>
        ...
        <th v-for="(item, index) in columns" :key="index">
          <div class="td" :style="`width: ${item.width}px;`">
            ...
            <VRenderTableCell v-else :render="item.render"></VRenderTableCell>
          </div>
        </th>
      </thead>
      <tbody>
        <tr v-for="(tr, index) in data" :key="index">
          ...
          <td v-for="(td, key) in columns" :key="key">
            <div class="td" :style="`width: ${td.width}px;`">
              ...
              <VRenderTableCell v-else-if="td.type !== 'image'" :render="td.cellRender" :val="{value: tr[td.prop]}"></VRenderTableCell>
              <VRenderTableCell v-else :render="td.cellRender" :val="tr"></VRenderTableCell>
            </div>
          </td>
        </tr>
      </tbody>
...
import VRenderTableCell from './VRenderTableCell';
type columnType = {
  label: string;
  prop: string;
  width?: number | string;
